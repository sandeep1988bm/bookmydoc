...
public class ControlServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (page.equals("admin_login.jsp")
			...
			Doctor D = new Doctor();
			int id1 = Integer.parseInt(req.getParameter("id"));
			String password1 = req.getParameter("d_password");
			...
			int id1 = Integer.parseInt(req.getParameter("id"));
			String password1 = req.getParameter("p_password");
			...
			String name1 = req.getParameter("d_name");
			String type1 = req.getParameter("d_speciality");
			...
			Patient P = new Patient();
			int age1 = Integer.parseInt(req.getParameter("p_age"));
			String password1 = req.getParameter("p_password");
			String name1 = req.getParameter("p_name");
